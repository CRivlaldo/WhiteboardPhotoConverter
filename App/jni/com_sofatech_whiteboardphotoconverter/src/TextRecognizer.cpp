...
TextRecognizer::TextRecognizer(BinaryBitmap* pBinaryBitmap,	const std::string& tesseractDataPath,
		Debugger* pDebugger)
{
...
bool TextRecognizer::RecognizeTextInternal(std::list<TextGlyph>& outTextGlyphs, std::string& errorText)
{
    ...
    if (pAPI->Init(tesseractDataPath.c_str(), "eng")) {
...
bool TextRecognizer::RecognizeText(BinaryBitmap* pBinaryBitmap, std::list<TextGlyph>& textGlyphs,
								   const std::string& tesseractDataPath, std::string& errorText,
								   Debugger* pDebugger)
{
	TextRecognizer textRecognizer(pBinaryBitmap, tesseractDataPath, pDebugger);
